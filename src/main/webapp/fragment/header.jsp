			...
			<div class="collapse navbar-collapse" id="navbarColor03">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item active"><a class="nav-link"
						href="/StarUp/index.jsp">首頁 <span class="sr-only">(current)</span>
					</a></li>
					<li class="nav-item"><a class="nav-link"
						href="<c:url value='/_10_personalPage/DisplayPersonalPage'/>">個人主頁</a></li>
					...
					<!-- 						</div></li> -->
					<li class="nav-item"><a class="nav-link"
						href="<c:url value='/_06_workUp/worksList.jsp'/>">探索作品</a></li>
					</li>
					<li class="nav-item disabled"><a class="nav-link" href="#">企劃招募</a></li>
					<li class="nav-item"><a class="nav-link"
						href="<c:url value='/_03_listProducts/DisplayPageProducts'/>">商城</a></li>
				</ul>
				...
				<c:if test="${!empty LoginOK}">
					<span class="badge badge-pill badge-warning"><a
						...
						style="text-decoration: none;">登出</a> </span> &nbsp;&nbsp;&nbsp; 
				...
				<c:if test="${empty LoginOK}">
					<span class="badge badge-pill badge-info"><a
						href="/StarUp/_01_register/Register.jsp"
						style="text-decoration: none;">註冊</a></span>
					&nbsp;&nbsp;&nbsp;
				</c:if>
				<!------------------------------------ Login Modal -------------------------------------->
				<div id="id01" class="modal">
					...
					<!-- Modal Content -->
					<form class="modal-content animate border-warning"
						...
						<div class="container">
							...
							<label for="account" style="margin: 15px;"><b>帳號</b></label> <input
								type="text" id="account" placeholder="Enter Username"
								name="account" value="${requestScope.user}" required autofocus>
							<br> <label for="password" style="margin: 15px;"><b>密碼</b></label>
							<input type="password" id="pswd" placeholder="Enter Password"
								name="password" value="${requestScope.password}" required>
