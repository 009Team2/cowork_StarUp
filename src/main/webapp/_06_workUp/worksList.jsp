...
<div class="carousel-inner"
	...
	<div class="carousel-item active"
		...
		<img class="d-block w-100" src="../images/night.jpg"
			alt="First slide ">
		<div class="container" style="display: flex; justify-content: center;">
			<div class="carousel-caption" style="margin-bottom: 150px;">
				...
				<p
					...
					<form
					class="form-inline my-10 my-lg-0">
            ...
            <div class="p-box wow fadeIn" style=" width: 100%; height:2100px; display:-ms-inline-grid; margin-left: 200px; ">
                <div class="p-container">
                    <img class="rounded-circle" height='45px' width='45px' src="../images/dir.jpg" style="margin-left:20px; margin-top: 5px;">
                    <p class="p-username">By 此木創遊 The Wood Games <span class="heart"style="margin-left: 1110px;">
                    ...
                    <div class="square">
                        ...
                        <div>
                            <p class="p-font"> 我們希望這樣的說明可以讓大家了解，並且不要因為是
                                ...
                                時更是影響局勢的關鍵呢。我們希望玩家也可以感受到這款遊戲的有趣之處 🙂
